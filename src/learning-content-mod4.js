...
module.exports = {
  'module-assessment': {
    trailer: { ru: 'https://tnemvzaxtgumtvijpfli.supabase.co/storage/v1/object/public/media/learning/prog7-trailer-ru.mp4', pl: 'https://tnemvzaxtgumtvijpfli.supabase.co/storage/v1/object/public/media/learning/prog7-trailer-pl.mp4', en: '' },
    sections: [
      // 1 — ВВЕДЕНИЕ
      {
        id: 'intro',
